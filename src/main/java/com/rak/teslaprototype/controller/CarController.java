...
public class CarController {
    ...
    public ResponseEntity<Object> getFeatures(@PathVariable String id) {
    ...
    public ResponseEntity<Object> getInterior(@PathVariable String id){
    ...
    public ResponseEntity<Object> getExterior(@PathVariable String id){
    ...
    public ResponseEntity<Object> getAutoPilot(@PathVariable String id){
