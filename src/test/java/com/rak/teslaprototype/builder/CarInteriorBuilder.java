...
public class CarInteriorBuilder {
    ...
    public List<CarInterior> build() {
        CarInterior carInterior1 = new CarInterior(id, description, option_included, price);
        CarInterior carInterior2 = new CarInterior(id2, description, option_included, price);
